...
\restrict ggishh9dOOHlVlsFI21YEn2aRZixRaw0RQqQ2CuXsvKek2SwUpWcM2bVZllvhVZ
...
SELECT pg_catalog.setval('public."Area_id_seq"', 55, true);
...
SELECT pg_catalog.setval('public."Management_id_seq"', 26, true);
...
SELECT pg_catalog.setval('public."Permission_id_seq"', 71, true);
...
\unrestrict ggishh9dOOHlVlsFI21YEn2aRZixRaw0RQqQ2CuXsvKek2SwUpWcM2bVZllvhVZ
