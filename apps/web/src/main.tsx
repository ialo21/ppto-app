  ...
  return (
    <aside className="sidebar-fixed">
      ...
      <nav className="space-y-1">
        ...
        <NavLink to="/provisions" className={({isActive})=>`${link} ${isActive?active:""}`}><Calendar size={18}/>Provisiones</NavLink>
...
function Topbar(){
  return (
    <header className="sticky top-0 z-10 flex items-center justify-between border-b border-border-default bg-surface/80 backdrop-blur p-3">
      <div className="font-medium text-text-primary">PPTO App</div>
    </header>
  );
}
