...
\restrict sYjqRjHZ6qaclat9g5aaS3BxIvKZrf1y0Td1cvHOd84cOgsUDg0h4t57VOQs15R
...
12	B0012	INSUMOS PARA IMPRESIÓN
41	B0049	SEÑALETICAS
60	S0026	SERVICIO DE DISEÑO GRAFICO, BRANDING
75	S0044	ASESORIA DISEÑO DE CONTENIDO DIGITAL
77	S0046	CONSULTORIA EN DISEÑO WEB
142	S0130	SERVICIOS DE DISEÑO, IMPRESIÓN, BRANDING
181	S0182	SERVICIO DE EQUIPOS DE IMPRESIÓN
\.
...
COPY public."Invoice" (id, "vendorId", "docType", "numberNorm", currency, "totalForeign", "totalLocal", "statusCurrent", "ultimusIncident", "approvedAt", "ocId", "montoSinIgv", detalle, "createdAt", "updatedAt", "exchangeRateOverride", "mesContable", "tcEstandar", "tcReal", "montoPEN_tcEstandar", "montoPEN_tcReal", "diferenciaTC") FROM stdin;
\.
...
COPY public."OC" (id, "budgetPeriodFromId", "budgetPeriodToId", "incidenteOc", "solicitudOc", "fechaRegistro", "supportId", "periodoEnFechasText", descripcion, "nombreSolicitante", "correoSolicitante", proveedor, ruc, moneda, "importeSinIgv", estado, "numeroOc", comentario, "articuloId", "cecoId", "linkCotizacion", "createdAt", "updatedAt") FROM stdin;
7	13	24	10001	SC0002014	2025-12-11 05:00:00	22	De enero a diciembre	Anx 14 al 29	Iago Lopez	iago.lopez@interseguro.com.pe	Hewlett	23432432423	USD	50000.000000000000000000000000000000	ATENDIDO	OC000124	\N	6	\N	https://docs.google.com/spreadsheets/d/1d8ClveLg8AiLi3BwuwJUJvqnaZKDzfe2wN6svYEeft0/edit?gid=43109189#gid=43109189	2025-12-11 21:43:34.174	2025-12-11 21:46:10.606
\.
...
13	7	31	2025-12-11 21:46:10.616
\.
...
COPY public."Permission" (id, key, name, description) FROM stdin;
1	dashboard	Dashboard	Vista principal con m├⌐tricas y estad├¡sticas
2	assistant	Asistente	Asistente IA para consultas
9	manage_roles	Gestión de Roles	Administrar roles y permisos (solo super admin)
3	reports	Reportes	Reportes y análisis de datos
4	facturas	Facturas	Gestión de facturas
6	provisiones	Provisiones	Gestión de provisiones
7	ppto	Presupuesto	Gestión del presupuesto
5	ocs	Órdenes de Compra	Gestión de órdenes de compra
8	catalogos	Catálogos	Administración de catálogos maestros
\.
...
1	super_admin	Administrador con acceso total al sistema	t	2025-12-03 16:40:03.391	2025-12-03 16:45:56.514
2	viewer	Usuario con acceso de solo lectura a módulos básicos	t	2025-12-03 17:52:36.99	2025-12-03 17:52:36.99
\.
...
18	1	1	2025-12-03 16:45:56.524
19	1	2	2025-12-03 16:45:56.524
20	1	3	2025-12-03 16:45:56.524
21	1	5	2025-12-03 16:45:56.524
22	1	6	2025-12-03 16:45:56.524
23	1	7	2025-12-03 16:45:56.524
24	1	8	2025-12-03 16:45:56.524
25	1	9	2025-12-03 16:45:56.524
26	1	4	2025-12-03 16:45:56.524
27	2	1	2025-12-03 17:52:37.001
28	2	2	2025-12-03 17:52:37.014
29	2	3	2025-12-03 17:52:37.022
\.
...
57	\N	Ingeniería Social	\N	\N	\N	\N	t	8	10	ADMINISTRATIVO	10	23
87	\N	Servicio envío de correo transaccional	\N	\N	\N	\N	t	8	6	ADMINISTRATIVO	5	8
...
59	\N	Licencia ATS Selección	\N	\N	\N	\N	t	8	6	ADMINISTRATIVO	10	19
24	\N	Botmaker - Implementación Y Operación Whatsapp	\N	\N	\N	\N	t	8	6	ADMINISTRATIVO	10	18
48	\N	Gestión DNS Público	\N	\N	\N	\N	t	8	6	ADMINISTRATIVO	5	9
108	\N	Suscripción Acsendo	\N	\N	\N	\N	t	8	6	ADMINISTRATIVO	10	19
110	\N	Suscripción Captcha	\N	\N	\N	\N	t	8	6	ADMINISTRATIVO	10	23
\.
...
28	24	5	2025-11-14 21:11:40.464
29	24	12	2025-11-14 21:11:40.464
30	24	7	2025-11-14 21:11:40.464
31	24	11	2025-11-14 21:11:40.464
32	24	10	2025-11-14 21:11:40.464
...
59	48	19	2025-11-14 21:11:40.719
...
70	57	22	2025-11-14 21:11:40.816
71	58	19	2025-11-14 21:11:40.826
72	59	20	2025-11-14 21:11:40.835
...
103	87	19	2025-11-14 21:11:41.105
...
124	108	20	2025-11-14 21:11:41.306
125	109	24	2025-11-14 21:11:41.316
126	110	22	2025-11-14 21:11:41.325
...
SELECT pg_catalog.setval('public."Area_id_seq"', 43, true);
...
SELECT pg_catalog.setval('public."Articulo_id_seq"', 217, true);
...
SELECT pg_catalog.setval('public."BudgetAllocation_id_seq"', 3969, true);
...
SELECT pg_catalog.setval('public."CostCenter_id_seq"', 35, true);
...
SELECT pg_catalog.setval('public."InvoiceCostCenter_id_seq"', 14, true);
...
SELECT pg_catalog.setval('public."InvoicePeriod_id_seq"', 20, true);
...
SELECT pg_catalog.setval('public."InvoiceStatusHistory_id_seq"', 19, true);
...
SELECT pg_catalog.setval('public."Invoice_id_seq"', 6, true);
...
SELECT pg_catalog.setval('public."Management_id_seq"', 20, true);
...
SELECT pg_catalog.setval('public."OCCostCenter_id_seq"', 13, true);
...
SELECT pg_catalog.setval('public."OC_id_seq"', 7, true);
...
SELECT pg_catalog.setval('public."RolePermission_id_seq"', 29, true);
...
SELECT pg_catalog.setval('public."SupportCostCenter_id_seq"', 130, true);
...
SELECT pg_catalog.setval('public."Support_id_seq"', 114, true);
...
--
-- Name: ux_alloc_version_period_support_ceco_type; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX ux_alloc_version_period_support_ceco_type ON public."BudgetAllocation" USING btree ("versionId", "periodId", "supportId", "costCenterId", "budgetType");
...
\unrestrict sYjqRjHZ6qaclat9g5aaS3BxIvKZrf1y0Td1cvHOd84cOgsUDg0h4t57VOQs15R
